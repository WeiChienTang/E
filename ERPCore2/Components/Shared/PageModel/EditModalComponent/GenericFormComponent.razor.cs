...
namespace ERPCore2.Components.Shared.PageModel.EditModalComponent;
...
public partial class GenericFormComponent<TModel> : ComponentBase, IDisposable
{
    ...
    protected ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant GetButtonVariant(string variant)
    {
        return variant switch
        {
            FormConstants.ButtonVariants.Primary => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.DarkBlue,
            FormConstants.ButtonVariants.Secondary => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.Gray,
            FormConstants.ButtonVariants.Success => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.Green,
            FormConstants.ButtonVariants.Danger => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.Red,
            FormConstants.ButtonVariants.Warning => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.Yellow,
            FormConstants.ButtonVariants.Info => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.Blue,
            FormConstants.ButtonVariants.OutlinePrimary => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.OutlineDarkBlue,
            FormConstants.ButtonVariants.OutlineSecondary => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.OutlineGray,
            FormConstants.ButtonVariants.OutlineSuccess => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.OutlineGreen,
            FormConstants.ButtonVariants.OutlineDanger => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.OutlineRed,
            FormConstants.ButtonVariants.OutlineWarning => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.OutlineYellow,
            FormConstants.ButtonVariants.OutlineInfo => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.OutlineBlue,
            _ => ERPCore2.Components.Shared.GenericComponent.Button.ButtonVariant.OutlineDarkBlue
        };
    }

    protected ERPCore2.Components.Shared.GenericComponent.Button.ButtonSize GetButtonSize(string size)
    {
        return size switch
        {
            FormConstants.ButtonSizes.Large => ERPCore2.Components.Shared.GenericComponent.Button.ButtonSize.Large,
            FormConstants.ButtonSizes.Normal => ERPCore2.Components.Shared.GenericComponent.Button.ButtonSize.Normal,
            FormConstants.ButtonSizes.Small => ERPCore2.Components.Shared.GenericComponent.Button.ButtonSize.Small,
