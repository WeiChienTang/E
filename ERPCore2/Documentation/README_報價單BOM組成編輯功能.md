...
在報價單明細中，當商品具有 BOM 組成時，允許使用者查看並編輯該商品的組成明細。編輯後的 BOM 資料僅影響當前報價單，不會修改產品合成表（ProductCompositionDetail）的原始資料。

### 核心需求
- ✅ 滑鼠移過或點擊商品時，可查看該商品的 BOM 組成
- ✅ 可編輯 BOM 組成的數量、單位、成本等資訊
- ✅ 編輯結果僅儲存在報價單中，不影響產品合成表
