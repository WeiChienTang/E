...
本資料夾收錄 ERPCore2 系統層級功能的設計文件，涵蓋系統參數管理、首頁客製化等跨模組的系統設定功能。
...
| [Readme_便利性功能_行事曆_便條貼設計.md](Readme_便利性功能_行事曆_便條貼設計.md) | 便條貼 & 行事曆 UX 設計、Slide-in Drawer、資料實體、實作分階計畫 |
| [Readme_系統代碼自動產生設計.md](Readme_系統代碼自動產生設計.md) | CodeSetting 實體、格式樣板 Token 設計、樂觀鎖並發機制、各模組遷移計畫 |
...
- [README_專案架構總綱.md](../專案架構/README_專案架構總綱.md) - 專案架構
