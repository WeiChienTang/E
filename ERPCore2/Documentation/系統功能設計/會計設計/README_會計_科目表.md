...
| Description | string? (Max 500) | 說明（中文）；子科目存放連結實體名稱（公司名/品項名） |
...
| LinkedProductId | int? | 連結品項 FK（SetNull on delete）；子科目專用 |
...
| 1 | EntityCode | 實體編碼，使用客戶/廠商/品項的 Code 作為後綴（1191.C0001） |
