    ...
    public class PermissionSeeder : IDataSeeder
    {
        ...
        private static async Task SeedPermissionsAsync(AppDbContext context)
        {
            ...
            var permissions = new[]
            {
                ...
                new Permission { PermissionCode = "IndustryType.Create", PermissionName = "建立產業類型", Module = "IndustryType", Action = "Create", PermissionGroup = "基礎單位", Status = EntityStatus.Active, CreatedAt = DateTime.Now, CreatedBy = "System" },
                new Permission { PermissionCode = "IndustryType.Read", PermissionName = "檢視產業類型", Module = "IndustryType", Action = "Read", PermissionGroup = "基礎單位", Status = EntityStatus.Active, CreatedAt = DateTime.Now, CreatedBy = "System" },
                new Permission { PermissionCode = "IndustryType.Update", PermissionName = "修改產業類型", Module = "IndustryType", Action = "Update", PermissionGroup = "基礎單位", Status = EntityStatus.Active, CreatedAt = DateTime.Now, CreatedBy = "System" },
                new Permission { PermissionCode = "IndustryType.Delete", PermissionName = "刪除產業類型", Module = "IndustryType", Action = "Delete", PermissionGroup = "基礎單位", Status = EntityStatus.Active, CreatedAt = DateTime.Now, CreatedBy = "System" },
