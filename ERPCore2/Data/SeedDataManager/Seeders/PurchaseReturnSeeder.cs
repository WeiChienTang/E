        ...
        private static async Task SeedPurchaseReturnsAsync(AppDbContext context)
        {
            ...
            var purchaseReturns = new[]
            {
                new PurchaseReturn
                {
                    ...
                    ReturnStatus = PurchaseReturnStatus.Completed,
                    ReturnReason = PurchaseReturnReason.QualityIssue,
                    ReturnDescription = "商品品質不符合標準",
                    ...
                    ProcessCompletedAt = DateTime.Today.AddDays(-5),
                ...
                new PurchaseReturn
                {
                    ...
                    SupplierId = supplier.Id,
                    PurchaseOrderId = purchaseOrder.Id,
                    ReturnStatus = PurchaseReturnStatus.Processing,
                    ReturnReason = PurchaseReturnReason.SpecificationMismatch,
                    ReturnDescription = "商品規格與訂單不符",
                    ...
                    ConfirmedAt = DateTime.Today.AddDays(-3),
                    WarehouseId = warehouse?.Id,
                    EmployeeId = employee?.Id,
                    ConfirmedBy = employee?.Id,
                    Status = EntityStatus.Active,
                ...
                new PurchaseReturn
                {
                    ...
                    SupplierId = supplier.Id,
                    ReturnStatus = PurchaseReturnStatus.Submitted,
                    ReturnReason = PurchaseReturnReason.QuantityError,
                    ReturnDescription = "實際收到數量與訂單不符",
