...
namespace ERPCore2.Data.Entities
{
    ...
    public class AccountsPayableSetoff : BaseEntity
    {
        ...
        /// 付款帳戶/現金
        /// </summary>
        [MaxLength(100, ErrorMessage = "付款帳戶不可超過100個字元")]
        [Display(Name = "付款帳戶")]
        ...
        /// 沖款明細導航屬性
        /// </summary>
        public ICollection<AccountsPayableSetoffDetail> SetoffDetails { get; set; } = new List<AccountsPayableSetoffDetail>();

        /// <summary>
        /// 付款明細導航屬性
        /// </summary>
        public ICollection<AccountsPayableSetoffPaymentDetail> PaymentDetails { get; set; } = new List<AccountsPayableSetoffPaymentDetail>();
    }
}
