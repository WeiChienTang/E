...
namespace ERPCore2.Services
{
    ...
    public interface IPurchaseReturnService : IGenericManagementService<PurchaseReturn>
    {
        ...
        /// </summary>
        Task<(List<PurchaseReturn> Items, int TotalCount)> GetPagedWithFiltersAsync(
        ...
        // 儲存和明細管理
        Task<ServiceResult<PurchaseReturn>> SaveWithDetailsAsync(PurchaseReturn purchaseReturn, List<PurchaseReturnDetail> details, bool updateInventory = true);
