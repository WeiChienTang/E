...
namespace ERPCore2.Services
{
    ...
    public class VehicleService : GenericManagementService<Vehicle>, IVehicleService
    {
        ...
        protected override IQueryable<Vehicle> BuildGetAllQuery(AppDbContext context)
        {
        ...
        public async Task<(List<Vehicle> Items, int TotalCount)> GetPagedWithFiltersAsync(
