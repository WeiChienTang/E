...
namespace ERPCore2.Services.Reports
{
    ...
    public class PurchaseReceivingReportService : IPurchaseReceivingReportService
    {
        ...
        public async Task<FormattedDocument> GenerateReportAsync(int purchaseReceivingId)
        {
            ...
            {
                supplier = await _supplierService.GetByIdAsync(purchaseReceiving.SupplierId.Value);
            }
        ...
        {
            var entities = await _purchaseReceivingService.GetByBatchCriteriaAsync(criteria);
