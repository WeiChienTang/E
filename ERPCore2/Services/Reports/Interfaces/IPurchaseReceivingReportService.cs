...
namespace ERPCore2.Services.Reports.Interfaces
{
    ...
    public interface IPurchaseReceivingReportService
    {
        ...
        Task<FormattedDocument> GenerateReportAsync(int purchaseReceivingId);
        ...
        Task<List<byte[]>> RenderToImagesAsync(int purchaseReceivingId);
        ...
        /// <returns>各頁面的圖片資料（PNG 格式）</returns>
        Task<List<byte[]>> RenderToImagesAsync(int purchaseReceivingId, PaperSetting paperSetting);
        ...
        Task<ServiceResult> DirectPrintAsync(int purchaseReceivingId, string reportId, int copies = 1);
