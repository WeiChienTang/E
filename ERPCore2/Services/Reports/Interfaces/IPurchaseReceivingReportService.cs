...
namespace ERPCore2.Services.Reports.Interfaces
{
    ...
    public interface IPurchaseReceivingReportService
    {
        ...
        /// <summary>
        /// 生成純文字格式的進貨單報表（適合直接列印和預覽）
        /// </summary>
        /// <param name="purchaseReceivingId">進貨單 ID</param>
        /// <returns>格式化的純文字報表內容</returns>
        Task<string> GeneratePlainTextReportAsync(int purchaseReceivingId);
        ...
        Task<ServiceResult> DirectPrintAsync(int purchaseReceivingId, string printerName);
        ...
        /// <returns>列印結果</returns>
        Task<ServiceResult> DirectPrintByReportIdAsync(int purchaseReceivingId, string reportId);
