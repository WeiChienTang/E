...
針對使用 `InteractiveTableComponent` 的多個 Table 組件進行重複代碼分析，提供可抽取為 Helper 的建議方案，減少編號重複並提高可維護性。
...
| Helper 類別 | 優先級 | 預估工作量 | 影響檔案數 | 可減少編號行數 | 節省維護成本 |
|------------|-------|----------|----------|--------------|------------|
