...
/// <summary>
/// 應付沖款單篩選條件（廠商沖款單，對應 FN004）
/// </summary>
public class AccountsPayableSetoffCriteria : IReportFilterCriteria
{
    /// <summary>
    /// 廠商 ID 清單（空表示全部）
    /// </summary>
    ...
    public BatchPrintCriteria ToBatchPrintCriteria()
    {
        return new BatchPrintCriteria
        {
            ...
            ReportType = ReportIds.AccountsPayableSetoff
        };
    }
    ...
    public string GetSummary()
    {
        ...
        {
            summary.Add($"廠商：{RelatedPartyIds.Count} 家");
        }
