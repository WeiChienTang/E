...
/// <summary>
/// 總分類帳篩選條件
/// 顯示指定期間內所有科目的帳戶卡片（期初餘額 + 逐筆明細 + 期末餘額）
/// </summary>
public class GeneralLedgerCriteria : IReportFilterCriteria
{
    /// <summary>
    /// 傳票日期範圍（本期明細起訖）
    ...
    /// <summary>
    /// 是否顯示無異動科目（期初期末餘額均為零且本期無發生額）
    /// </summary>
    [FilterToggle(Group = FilterGroup.Basic, Label = "顯示選項", CheckboxLabel = "顯示無異動科目", DefaultValue = false, Order = 2)]
